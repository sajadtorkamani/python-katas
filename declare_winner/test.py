...
class DeclarWinnerTets(unittest.TestCase):
    def test_returns_correct_result(self):
        self.assertEqual(
            declare_winner(Fighter("Lew", 10, 2), Fighter("Harry", 5, 4), "Lew"),
            "Lew"
        )
        # self.assertEqual(declare_winner(Fighter("Lew", 10, 2), Fighter("Harry", 5, 4), "Harry"),
        #                   "Harry")
        # self.assertEqual(declare_winner(Fighter("Harald", 20, 5), Fighter("Harry", 5, 4), "Harry"),
        #                   "Harald")
        # self.assertEqual(
